...
\]
These finite-$n$ variances provide approximate confidence bands for testing observed fluorescence ratios against the i.i.d.\ null model; for short amyloids, the exact distributions $P(n,k)$ should be used directly.
