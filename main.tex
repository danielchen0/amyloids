...
\]
Note the convention change from Sections 2--3: there, $R(n) = 2E(n)/n$ measured the fraction of \textit{proteins} involved in fluorescence (two per fused pair), whereas here $R(n) = E(n)/n$ measures total fluorescence units per protein, since $E(n)$ already counts FRET contributions directly.
