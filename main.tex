...
\caption{$R(n)$ for split-YFP amyloids. The blue line is $2/3$ and the orange curve is the exact $R(n)$. The exponential correction term $O(2^{-n}/n)$ yields rapid convergence.}
\label{fig:splityfp}
\end{figure}
...
\caption{$R(n)$ for split-YFP amyloids with Sup35p. The blue line is $1/3$ and the orange curve is the exact $R(n)$. The exponential correction term $O(3^{-n}/n)$ yields even faster convergence than Figure~\ref{fig:splityfp}.}
\label{fig:sup35}
\end{figure}
...
\caption{$R(n)$ for FRET YFP/CFP amyloids. The blue line is $1/2$ and the orange curve is the exact $R(n) = (n-1)/(2n)$. Convergence is algebraic ($O(1/n)$), with no exponential correction.}
\label{fig:fretonly}
\end{figure}
...
\caption{$R(n)$ for FRET YFP/CFP amyloids with Sup35p. The blue line is $2/9$ and the orange curve is the exact $R(n) = 2(n-1)/(9n)$. Convergence is algebraic ($O(1/n)$), as in Figure~\ref{fig:fretonly}.}
\label{fig:fretsup35}
\end{figure}
...
\begin{tabular}{lcccc}
\hline
System & $R(n)$ def. & Exact $E(n)$ & Exact $R(n)$ & $\displaystyle\lim_{n\to\infty} R(n)$ \\
\hline
Split-YFP (Sec.~2) & $\dfrac{2E(n)}{n}$ & $\dfrac{3n-2}{9} + \dfrac{2(-1)^n}{9 \cdot 2^n}$ & $\dfrac{2(3n-2)}{9n} + \dfrac{2(-1)^n}{9n \cdot 2^{n-1}}$ & $2/3$ \\[8pt]
Split-YFP + Sup35p (Sec.~3) & $\dfrac{2E(n)}{n}$ & $\dfrac{4n-3}{24} - \dfrac{(-1)^{n-1}}{24 \cdot 3^{n-1}}$ & $\dfrac{4n-3}{12n} + \dfrac{(-1)^n}{12n \cdot 3^{n-1}}$ & $1/3$ \\[8pt]
FRET YFP/CFP (Sec.~4) & $\dfrac{E(n)}{n}$ & $\dfrac{n-1}{2}$ & $\dfrac{n-1}{2n}$ & $1/2$ \\[8pt]
FRET + Sup35p (Sec.~5) & $\dfrac{E(n)}{n}$ & $\dfrac{2(n-1)}{9}$ & $\dfrac{2(n-1)}{9n}$ & $2/9$ \\[4pt]
\hline
\end{tabular}
\end{center}
