...
\]
Indeed, the number of ways to place $k$ non-adjacent objects in $m$ boxes is $\binom{m-k+1}{k}$ (see \cite[Ch.~1]{stanley2012}); setting $m = n - 1$ gives $\binom{n-k}{k}$ as claimed.
...
We will use the identity (see, e.g., \cite[Ch.~2]{wilf2006}) that for any fixed $j \ge 0$,
...
Note that, by a standard identity \cite[Ch.~5]{gkp1994}:
